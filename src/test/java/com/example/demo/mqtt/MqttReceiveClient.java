...
public class MqttReceiveClient {
    ...
    public MqttReceiveClient(String host, String userName, String passWord, String clientId, String receiveTopicId, String pushTopicId) throws MqttException {
...
//            options.setWill(topic, "close".getBytes(), 2, true);
            ...
            //订阅消息
            int[] qos  = {1};
            log.info("订阅mqtt消息，topic=" + receiveTopicId);
            String[] topic1 = {receiveTopicId};
...
//		关闭连接
    ...
    public static void main(String[] args) {
        try {
            MqttReceiveClient client = new MqttReceiveClient("tcp://118.89.38.157:1883","","","clientid","push","push");
            client.start();
